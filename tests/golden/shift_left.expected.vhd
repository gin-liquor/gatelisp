...
entity gl_m0_shift_left_example is
  port (
    gl_p0_input : in unsigned(7 downto 0);
    gl_p1_value : out unsigned(7 downto 0)
  );
end entity gl_m0_shift_left_example;

library ieee;
use ieee.std_logic_1164.all;
use ieee.numeric_std.all;

architecture rtl of gl_m0_shift_left_example is
...
begin
  ...
  begin
    gl_s1_value <= shift_left(gl_p0_input, 2);
