...
entity gl_m0_resize_signed is
  port (
    gl_p0_input : in signed(7 downto 0);
    gl_p1_value : out signed(15 downto 0)
  );
end entity gl_m0_resize_signed;

library ieee;
use ieee.std_logic_1164.all;
use ieee.numeric_std.all;

architecture rtl of gl_m0_resize_signed is
  signal gl_s1_value : signed(15 downto 0);
