...
entity gl_m0_slice_example is
  port (
    gl_p0_input : in unsigned(15 downto 0);
    gl_p1_low : out unsigned(7 downto 0);
    gl_p2_high : out unsigned(7 downto 0)
  );
end entity gl_m0_slice_example;

library ieee;
use ieee.std_logic_1164.all;
use ieee.numeric_std.all;

architecture rtl of gl_m0_slice_example is
  signal gl_s1_low : unsigned(7 downto 0);
  signal gl_s2_high : unsigned(7 downto 0);
...
begin
  ...
  begin
    gl_s2_high <= unsigned(gl_p0_input(((8 + 8) - 1) downto 8));
